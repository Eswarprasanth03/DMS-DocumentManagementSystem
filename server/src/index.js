...
// Retention scheduler — stands in for the guide's cron; recomputes lifecycle
// state (active / expiring / expired) on an interval. Guarded so a single bad
// record can never prevent the API from starting.
